...
ifeq ($(PLATFORM),WINDOWS)
    ...
    COMPILERFLAGS += -s WASM=$WASM -s USE_PTHREADS=1 -s EMULATE_FUNCTION_POINTER_CASTS=1
    LINKERFLAGS += -o nblood.html -s WASM=$WASM -s USE_PTHREADS=1 -s EMULATE_FUNCTION_POINTER_CASTS=1 -s USE_SDL=2 -s USE_SDL_MIXER=2
